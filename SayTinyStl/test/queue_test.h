#ifndef SAYTINYSTL_QUEUE_TEST_H
#define SAYTINYSTL_QUEUE_TEST_H

// queue test: 测试 queue 和 prioriy_queue的接口和他们的 push 性能
...
namespace saystl {
	namespace test {
		namespace queue_test {
            ...
            void queue_print(saystl::queue<int> q)
            {
                while (!q.empty())
                {
                    std::cout << " " << q.front();
            ...
            void p_queue_print(saystl::priority_queue<int> p)
            {
                while (!p.empty())
                {
                    std::cout << " " << p.top();
...
#define P_QUEUE_FUN_AFTER(con, fun) do {         \
  ...
  P_QUEUE_COUT(con);                             \
            ...
            void queue_test()
            {
                ...
                int a[] = { 1,2,3,4,5 };
                saystl::deque<int> d1(5);
                saystl::queue<int> q1;
                saystl::queue<int> q2(5);
                saystl::queue<int> q3(5, 1);
                saystl::queue<int> q4(a, a + 5);
                saystl::queue<int> q5(d1);
                saystl::queue<int> q6(std::move(d1));
                saystl::queue<int> q7(q2);
                saystl::queue<int> q8(std::move(q2));
                saystl::queue<int> q9;
                q9 = q3;
                saystl::queue<int> q10;
                q10 = std::move(q3);
                saystl::queue<int> q11{ 1, 2, 3, 4, 5 };
                saystl::queue<int> q12;
                q12 = { 1,2,3,4,5 };
            ...
            void priority_test()
            {
                ...
                std::cout << "[-------------------------- API test ---------------------------]" << std::endl;
                int a[] = { 1,2,3,4,5 };
                saystl::vector<int> v1(5);
                saystl::priority_queue<int> p1;
                saystl::priority_queue<int> p2(5);
                saystl::priority_queue<int> p3(5, 1);
                saystl::priority_queue<int> p4(a, a + 5);
                saystl::priority_queue<int> p5(v1);
                saystl::priority_queue<int> p6(std::move(v1));
                saystl::priority_queue<int> p7(p2);
                saystl::priority_queue<int> p8(std::move(p2));
                saystl::priority_queue<int> p9;
                p9 = p3;
                saystl::priority_queue<int> p10;
                p10 = std::move(p3);
                saystl::priority_queue<int> p11{ 1, 2, 3, 4, 5 };
                saystl::priority_queue<int> p12;
                p12 = { 1,2,3,4,5 };
