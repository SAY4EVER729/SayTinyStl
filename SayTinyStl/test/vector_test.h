#ifndef SAYTINYSTL_VECTOR_TEST_H_
#define SAYTINYSTL_VECTOR_TEST_H_
...
namespace saystl {
	namespace test {
		namespace vector_say_test {
			void vector_test() {
				std::cout << "[===============================================================]\n";
				std::cout << "[----------------- Run container test : vector -----------------]\n";
				std::cout << "[-------------------------- API test ---------------------------]\n";
				int a[] = { 1,2,3,4,5 };
				saystl::vector<int> v1;
				saystl::vector<int> v2(10);
				saystl::vector<int> v3(10, 1);
				saystl::vector<int> v4(a, a + 5);
				saystl::vector<int> v5(v2);
				saystl::vector<int> v6(std::move(v2));
				saystl::vector<int> v7{ 1, 2, 3, 4, 5, 6, 7, 8, 9 };
				saystl::vector<int> v8, v9, v10;
				v8 = v3;
				v9 = std::move(v3);
...
#endif// !SAYTINYSTL_VECTOR_TEST_H_
