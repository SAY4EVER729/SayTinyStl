	...
	namespace test
	{
		namespace deque_test
		{
			...
			void deque_test()
			{
				...
				int a[] = { 1,2,3,4,5 };
				saystl::deque<int> d1;
				saystl::deque<int> d2(5);
				saystl::deque<int> d3(5, 1);
				saystl::deque<int> d4(a, a + 5);
				saystl::deque<int> d5(d2);
				saystl::deque<int> d6(std::move(d2));
				saystl::deque<int> d7;
				d7 = d3;
				saystl::deque<int> d8;
				d8 = std::move(d3);
				saystl::deque<int> d9{ 1, 2, 3, 4, 5, 6, 7, 8, 9 };
				saystl::deque<int> d10;
