#ifndef SAYTINYSTL_TEST_H
#define SAYTINYSTL_TEST_H
...
saystl::vector<long> v3(arr, arr + 3);
...
#define CON_TEST_P1(con, fun, arg, len1, len2, len3)         \
  ...
  std::cout << "\n|        saystl        |";                  \
  FUN_TEST_FORMAT1(saystl::con, fun, arg, len1);              \
  FUN_TEST_FORMAT1(saystl::con, fun, arg, len2);              \
  FUN_TEST_FORMAT1(saystl::con, fun, arg, len3);    
...
#define CON_TEST_P2(con, fun, arg1, arg2, len1, len2, len3)  \
  ...
  std::cout << "\n|        saystl        |";                  \
  FUN_TEST_FORMAT2(saystl::con, fun, arg1, arg2, len1);       \
  FUN_TEST_FORMAT2(saystl::con, fun, arg1, arg2, len2);       \
  FUN_TEST_FORMAT2(saystl::con, fun, arg1, arg2, len3);    
...
#define MAP_EMPLACE_TEST(con, len1, len2, len3)              \
  ...
  std::cout << "\n|        saystl        |";                  \
  MAP_EMPLACE_DO_TEST(saystl, con, len1);                     \
  MAP_EMPLACE_DO_TEST(saystl, con, len2);                     \
  MAP_EMPLACE_DO_TEST(saystl, con, len3);
...
#define LIST_SORT_TEST(len1, len2, len3)                     \
  ...
  std::cout << "\n|        saystl        |";                  \
  LIST_SORT_DO_TEST(saystl, len1);                            \
  LIST_SORT_DO_TEST(saystl, len2);                            \
  LIST_SORT_DO_TEST(saystl, len3);
...
#define RUN_ALL_TESTS() \
  saystl::test::UnitTest::GetInstance()->Run()
