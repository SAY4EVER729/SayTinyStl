#ifndef SAYTINYSTL_STRING_TEST_H
#define SAYTINYSTL_STRING_TEST_H

// string test 测试 string 的接口 和 insert 的功能
	...
	namespace test {
		namespace string_test {
			void string_test()
			{
				...
				saystl::string str;
				saystl::string str1(5, 'a');
				saystl::string str2(str1, 3);
				saystl::string str3(str1, 0, 3);
				saystl::string str4("abc");
				saystl::string str5("abcde", 3);
				saystl::string str6(s, s + 5);
				saystl::string str7(str1);
				saystl::string str8(std::move(str1));
				saystl::string str9;
				str9 = str2;
				saystl::string str10;
				str10 = std::move(str2);
...
#endif // !SAYTINYSTL_STRING_TEST_H
